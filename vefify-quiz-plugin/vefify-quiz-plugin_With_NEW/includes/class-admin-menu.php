...
class Vefify_Quiz_Admin_Menu {
    ...
    private function define_menu_structure() {
        $this->pages = array(
            'main' => array(
                'page_title' => __('Vefify Quiz Dashboard', 'vefify-quiz'),
                'menu_title' => __('Vefify Quiz', 'vefify-quiz'),
            ...
            'submenus' => array(
                'dashboard' => array(
                    ...
                    'page_title' => __('Dashboard', 'vefify-quiz'),
                    'menu_title' => __('📊 Dashboard', 'vefify-quiz'),
                    'capability' => 'manage_options',
                    'menu_slug' => 'vefify-quiz',
                    'callback' => array($this, 'render_dashboard')
                ),
                'campaigns' => array(
                    'parent_slug' => 'vefify-quiz',
                    'page_title' => __('Campaign Management', 'vefify-quiz'),
                    'menu_title' => __('📋 Campaigns', 'vefify-quiz'),
                    'capability' => 'manage_options',
                ...
                'questions' => array(
                    'parent_slug' => 'vefify-quiz',
                    'page_title' => __('Question Bank', 'vefify-quiz'),
                    'menu_title' => __('❓ Questions', 'vefify-quiz'),
                    'capability' => 'manage_options',
                ...
                'participants' => array(
                    'parent_slug' => 'vefify-quiz',
                    'page_title' => __('Participants & Results', 'vefify-quiz'),
                    'menu_title' => __('👥 Participants', 'vefify-quiz'),
                    'capability' => 'manage_options',
                ...
                'gifts' => array(
                    'parent_slug' => 'vefify-quiz',
                    'page_title' => __('Gift Management', 'vefify-quiz'),
                    'menu_title' => __('🎁 Gifts', 'vefify-quiz'),
                    'capability' => 'manage_options',
                ...
                'analytics' => array(
                    'parent_slug' => 'vefify-quiz',
                    'page_title' => __('Analytics & Reports', 'vefify-quiz'),
                    'menu_title' => __('📈 Analytics', 'vefify-quiz'),
                    'capability' => 'manage_options',
                ...
                'settings' => array(
                    'parent_slug' => 'vefify-quiz',
                    'page_title' => __('Settings & Configuration', 'vefify-quiz'),
                    'menu_title' => __('⚙️ Settings', 'vefify-quiz'),
                    'capability' => 'manage_options',
